...
export const jsons2csv = (
  ...
  joiner(jsons2arrays(data, headers), separator, enclosingCharacter, newline);
...
export const toCSV = (
  ...
  if (isJsons(data))
    return jsons2csv(data, headers, separator, enclosingCharacter, newline);
  if (isArrays(data))
    return arrays2csv(data, headers, separator, enclosingCharacter, newline);
  if (typeof data === "string")
    return string2csv(data, headers, separator, newline);
  throw new TypeError(
...
export const buildURI = (
  ...
  const csv = toCSV(data, headers, separator, enclosingCharacter, newline);
